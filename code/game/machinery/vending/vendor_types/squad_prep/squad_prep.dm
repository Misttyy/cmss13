...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/squad_prep/populate_product_list(var/scale)
	listed_products = list(
		...
		list("M4RA Designated Marksmen Rifle", round(scale * 10), /obj/item/weapon/gun/rifle/m4ra/dmr, VENDOR_ITEM_REGULAR),
		...
		list("M4RA Standard Magazine", round(scale * 15), /obj/item/ammo_magazine/rifle/m4radmr, VENDOR_ITEM_REGULAR),
