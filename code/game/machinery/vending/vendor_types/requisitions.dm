...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/populate_product_list(var/scale)
	listed_products = list(
		...
		list("M4RA Designated Marksmen Rifle", round(scale * 20), /obj/item/weapon/gun/rifle/m4ra/dmr, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/cargo_ammo/populate_product_list(var/scale)
	listed_products = list(
		...
		list("M4RA Standard Magazine", round(scale * 8), /obj/item/ammo_magazine/rifle/m4radmr, VENDOR_ITEM_REGULAR),
		...
		list("Magazine Box (M4RA x 16)", round(scale * 0.8), /obj/item/ammo_box/magazine/m4ra, VENDOR_ITEM_REGULAR),
