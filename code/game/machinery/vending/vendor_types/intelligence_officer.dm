...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/intelligence_officer
	...
	listed_products = list(
		...
		list("M4RA Designated Marksmen Rifle", 4, /obj/item/weapon/gun/rifle/m4ra/dmr, VENDOR_ITEM_REGULAR),
		...
		list("M4RA Standard Magazine", 24, /obj/item/ammo_magazine/rifle/m4radmr, VENDOR_ITEM_REGULAR),
