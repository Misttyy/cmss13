...
/obj/structure/machinery/cm_vending/sorted/vehicle_supply/populate_product_list(var/scale)
	listed_products = list(
		...
		list("M4RA Designated Marksmen Rifle", round(scale * 2), /obj/item/weapon/gun/rifle/m4ra, VENDOR_ITEM_REGULAR),
		...
		list("M4RA Standard Magazine", round(scale * 5), /obj/item/ammo_magazine/rifle/m4radmr, VENDOR_ITEM_REGULAR),
